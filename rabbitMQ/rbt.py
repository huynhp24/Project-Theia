...
import shutil
import requests
sys.path.insert(1,'/opt/theia/severside')
...
def storeToDB(imgFile, id):
    ...
    if (conn):
        ...
        sen = language.generate_nat_string(labelResult)  ##### <--- change your natural fucntion right here !!! Update the import above at line 13
