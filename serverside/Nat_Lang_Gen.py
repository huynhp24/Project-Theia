...
def Run(impLabels,text):
    ...
    try:
        ...
        summary = "We were unable to generate human results. Here are texts found in the image: " + str(text_extracted) + " \nAnd here are things we found in the image: " + str(labels)
    return summary[:300]